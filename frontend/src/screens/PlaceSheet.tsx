    ...
    <>
      ...
      <div className="sheet ps" role="dialog" aria-label={`${place.name} 위치`}>
        ...
        <div className="ps-links">
          <Button tone="coral" onClick={() => window.open(naverMapUrl(place), '_blank', 'noopener')}>네이버 지도에서 보기</Button>
          <Button onClick={() => window.open(googleMapUrl(place), '_blank', 'noopener')}>구글 맵에서 보기</Button>
        </div>

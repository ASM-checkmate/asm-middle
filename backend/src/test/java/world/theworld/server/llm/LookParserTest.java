...
class LookParserTest {
  @Test
  void normal() {
    LookParsed p = LookParser.parse("{\"skin\":\"dark\",\"hairColor\":\"black\",\"hairStyle\":\"short\",\"glasses\":\"none\",\"beard\":\"none\",\"top\":\"night\",\"seen\":\"짙은 정장의 남성\"}");
    assertThat(p.look()).isEqualTo(new Look("dark", "black", "short", "none", "none", "night"));
    assertThat(p.seen()).isEqualTo("짙은 정장의 남성");
  }

  @Test
  void invalidEnumFallsBackToDefault() {
    LookParsed p = LookParser.parse("{\"skin\":\"olive\",\"hairColor\":\"black\",\"hairStyle\":\"mohawk\",\"glasses\":\"sun\",\"beard\":\"none\",\"top\":\"purple\",\"seen\":\"x\"}");
    assertThat(p.look()).isEqualTo(new Look("fair", "black", "bowl", "none", "none", "coral"));
  }

  @Test
  void missingFieldsAreDefaults() {
    LookParsed p = LookParser.parse("{\"hairColor\":\"blond\"}");
    assertThat(p.look()).isEqualTo(new Look("fair", "blond", "bowl", "none", "none", "coral"));

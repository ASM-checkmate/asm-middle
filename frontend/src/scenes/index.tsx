...
// ─── scenes ─────────────────────────────────────────────────────────────────
// 깊이 층 (ADR-0014 2.5D): 카메라 무대에서 방향·각도에 따라 층마다 다르게 밀린다 (camera.css .cam-stage .sc-*). 무대 밖에선 아무 효과 없다.
// 기준은 캐릭터 발(y≈455): far = 벽·하늘·먼 것 · mid = 발보다 위에 서 있는 것(뒤) · floor = 바닥 · front = 발보다 아래에 놓인 것(앞).

type Depth = 'far' | 'mid' | 'floor' | 'front';
